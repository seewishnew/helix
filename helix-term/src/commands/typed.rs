...
pub mod global_search {
    ...
    use crate::{
        ...
        ui::{self, overlay::overlaid, FilePicker},
    };
...
pub const TYPABLE_COMMAND_LIST: &[TypableCommand] = &[
        ...
        TypableCommand {
            ...
            signature: CommandSignature::all(completers::regex_template),
        },
        TypableCommand {
            name: "global_search",
            aliases: &["gs"],
            ...
            signature: CommandSignature::all(completers::regex),
        },
        TypableCommand {
            name: "write",
            aliases: &["w"],
    ...
    let mut prompt = Prompt::new(
        ...
        |editor: &Editor, input: &str| {
            ...
            if words.is_empty() || (words.len() == 1 && !shellwords.ends_with_whitespace()) {
                ...
                if let Some((name, completer)) = typed::TYPABLE_COMMAND_MAP
                    .get(&words[0] as &str)
                    .map(|tc| (tc.name, tc.completer_for_argument_number(argument_number)))
                {
